      ...
      <Switch>
        ...
        <Route path='/'>
          <Container fluid='lg'>
            ...
            {(roster != null) && isRoster40k9e(roster) ? <RosterView40k9e name={roster.name} faction={roster.faction} subfaction={roster.subfaction} units={roster.units} onClose={handleClose} settings={settings} stratagems={roster.stratagems} /> : <></>}
          </Container>
        </Route>
      </Switch>
    </Router>
