...
import { Roster as RosterViewNecromunda } from './components/Necromunda/Roster'
...
export function App(): JSX.Element {
  const [roster, setRoster] = useState<Roster2018 | Roster2021 | RosterWH40k9e | Gang | null>(null)
  ...
  const isRosterNecromunda = (roster: any): roster is Gang => (roster.system === 'Necromunda')
      ...
      <Switch>
        ...
        <Route path='/'>
          <Container fluid='lg'>
            ...
            {(roster != null) && isRoster40k9e(roster) ? <RosterView40k9e name={roster.name} faction={roster.faction} subfaction={roster.subfaction} units={roster.units} abilities={roster.abilities} onClose={handleClose} settings={settings} stratagems={roster.stratagems} /> : <></>}
            {(roster != null) && isRosterNecromunda(roster) ? <RosterViewNecromunda gang={roster} onClose={handleClose} /> : <></>}
          </Container>
        </Route>
      </Switch>
    </Router>
