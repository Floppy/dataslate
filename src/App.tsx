      ...
      <Switch>
        ...
        <Route path='/'>
          <Container fluid='lg'>
            ...
            {(roster != null) && isRoster40k9e(roster) ? <RosterView40k9e name={roster.name} faction={roster.faction} datasheets={roster.datasheets} onClose={handleClose} settings={settings} /> : <></>}
          </Container>
        </Route>
      </Switch>
    </Router>
