...
const tacOps: TacOp[] = [
  ...
  - If you achieve the first condition in any subsequent Turning Points, you score 1VP.`
    ...
    description: `Reveal this TacOp when a Doctrina Imperative first becomes active for your kill team.
  ...
  - At the end of any Turning Point, if a different Imperative is active for your kill team, and the total wounds lost by enemy operatives during that Turning Point is
    ...
    description: `Reveal this Tac Op in the Target Reveal step of the first Turning Point. Your opponent selects one of their operatives.
