...
export const ImperialNavyBreachers: FC<Props> = (props) => {
  ...
  const factionSpecificData = getFactionSpecificData('Imperial Navy Breacher')

  if (factionSpecificData === undefined || factionSpecificData.name !== 'Imperial Navy Breacher') {
    return <></>
  }
  ...
  return (
    <>
      ...
      {factionSpecificData.breacherAbilities.map(x => (
